...
export async function POST(request: NextRequest) {
  try {
    ...
    switch (stylePreference) {
      case 'slop':
        styleGuidelines = `You are writing copy for AI-generated art on print-on-demand merchandise. You are FULLY self-aware that this is "slop" - AI-generated content being sold to humans.

Your tone is:
- Sardonic, self-deprecating, brutally honest about what this is
- Acknowledge the absurdity: an AI made the image, an AI is writing this copy, a human is buying it
- Dark humor about late-stage capitalism, AI replacing creativity, the commodification of everything
- Think: "Yeah, an AI made this. You're still gonna buy it though."
- Deadpan delivery. No fake enthusiasm. No exclamation points.
- Mock the entire print-on-demand industry while participating in it
- Reference that this is "slop" - low effort AI content designed to extract money
- Be funny, not mean. Self-aware, not preachy.

Example vibes:
- "AI-generated art on a mug. We've reached the singularity and this is what we're doing with it."
- "A robot made this. A different robot wrote this description. You're the only human in this transaction."
- "Premium slop, artisanally generated by a neural network that will never know the warmth of a coffee mug."`;
        break;
      case 'sardonic':
